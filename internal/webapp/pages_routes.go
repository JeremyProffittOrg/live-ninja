...
const pageCSP = "default-src 'self'; " +
	...
	// only other extra origin. Voice Live WSS is the Entra-token control
	// socket (azure-voice-plan.md E1).
	"connect-src 'self' https://api.openai.com https://ln-aoai-eastus2.openai.azure.com wss://ln-voicelive.services.ai.azure.com wss://generativelanguage.googleapis.com https://live-ninja-wakewords-759775734231.s3.amazonaws.com https://live-ninja-wakewords-759775734231.s3.us-east-1.amazonaws.com wss://a17oe0gnthrosw-ats.iot.us-east-1.amazonaws.com; " +
	"media-src 'self' blob:; " +
