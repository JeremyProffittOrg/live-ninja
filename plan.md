...
> - **NEW Tab5 owner requirements (open, tasks #6/#7):** portal reachable but requests time out; no on-device indication when a client joins the AP/portal; LCD setup must offer BOTH join-WiFi (scanned-SSID list + keyboard) AND AP mode (default 10.x, selectable 10./192.); layout: welcome top, QR heroed at BOTTOM.
