...
> 10. `[ ]` **Task #7 queued** (fully specified, ready): raw LLM transcripts in history detail; per-session cost persisted on CONV + shown in history list/detail + menu; "long conversations" (>8 turns) filter button.
