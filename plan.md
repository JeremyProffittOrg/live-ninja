...
> 3. **Transcript-ordering live check** (agent-runnable): PowerShell TTS speaker test (recipe in item 2 below) — confirm the user's question renders ABOVE the assistant reply now.
