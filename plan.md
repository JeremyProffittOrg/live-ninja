...
> - **"Save a file" could never work**: deliverable_create/zip/deliver were in the tool ROUTER but never declared in the broker's session toolManifest — the model didn't know they existed. Added.
