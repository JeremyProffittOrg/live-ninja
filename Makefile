...
FUNCTIONS := web authorizer iot-authorizer realtime-broker iot-ingest usage-rollup email-dispatch deliverables-zipper shadow-ingest topics-extract account-purge rca-analyzer codeupdate-dispatch
